...
- Dashboard task summary, Maintenance task overview, and task center with queue progress overview, elapsed/remaining time estimates, text search, status/type filters, searchable expandable logs, retry, and cancellation for supported operations
