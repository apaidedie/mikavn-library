...
- Dashboard task summary plus task center with queue progress overview, elapsed/remaining time estimates, text search, status/type filters, searchable expandable logs, and retry for supported failed/cancelled operations
