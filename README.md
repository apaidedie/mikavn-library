...
- Batch metadata matching with candidate review, result status/write filters, filtered bulk writeback, stored job/result status, and user-confirmed writeback
