...
- Batch metadata updates with resettable queue search/provider-gap filters, result status/write-state filters, and filtered bulk writeback for reviewing large match result sets.
