      ...
      <div className="relative border-b border-white/10 px-7 py-5 pt-6">
        <div className="relative flex flex-col gap-5">
          <div className="flex items-end justify-between gap-7">
            ...
            <CoverImage alt={game.title} blur={blurCover} className="aspect-[2/3] h-[170px] shrink-0 rounded-lg shadow-2xl shadow-black/45 ring-1 ring-white/10" fetchPriority="high" loading="eager" src={game.coverImage} />
          </div>
